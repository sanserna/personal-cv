          ...
          <SectionContainer>
            <Card>
              <div className={resumeStyles.shortBio}>
                <Img
                  fixed={resumeAvatar.childImageSharp.fixed}
                  className={resumeStyles.shortBio__imageContainer}
                />
                <p className={resumeStyles.shortBio__text}>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Consectetur sunt provident tempore, magni omnis facilis
                  accusamus laborum illum, molestiae ratione labore debitis
                  architecto commodi delectus corrupti saepe quae vel porro!
                </p>
              </div>
